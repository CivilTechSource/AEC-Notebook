...
(function () {
  const ICON = {
    ...
    // Named by a plugin manifest via contributes.activity.icon, not used by the app itself.
    // A rosette over a checklist — the CPD tracker's ribbon button.
    cpd:    '<svg width="18" height="18" viewBox="0 0 18 18" fill="none"><path d="M3 2.8h7.5a.7.7 0 01.7.7v11a.7.7 0 01-.7.7H3a.7.7 0 01-.7-.7v-11a.7.7 0 01.7-.7z" stroke="currentColor" stroke-width="1.25"/><path d="M4.6 6.2h4.3M4.6 9h4.3M4.6 11.8h2.6" stroke="currentColor" stroke-width="1.15" stroke-linecap="round"/><circle cx="13.4" cy="5.6" r="2.9" stroke="currentColor" stroke-width="1.25"/><path d="M11.9 8.1l-.5 3.2 2-1.1 2 1.1-.5-3.2" stroke="currentColor" stroke-width="1.25" stroke-linejoin="round"/></svg>',
    ...
    help:     '<svg width="18" height="18" viewBox="0 0 18 18" fill="none"><circle cx="9" cy="9" r="6.6" stroke="currentColor" stroke-width="1.3"/><path d="M7.1 7a2 2 0 013.8.7c0 1.4-1.9 1.7-1.9 3" stroke="currentColor" stroke-width="1.3" stroke-linecap="round"/><circle cx="9" cy="13" r=".85" fill="currentColor"/></svg>',
    // attachments: paperclip for the section, then one glyph per broad file kind
    clip:     '<svg width="15" height="15" viewBox="0 0 15 15" fill="none"><path d="M10.6 4.3L5.4 9.5a1.7 1.7 0 002.4 2.4l5.2-5.2a3.1 3.1 0 00-4.4-4.4L3.1 7.8a4.5 4.5 0 006.4 6.4" stroke="currentColor" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"/></svg>',
    image:    '<svg width="15" height="15" viewBox="0 0 15 15" fill="none"><rect x="1.8" y="2.5" width="11.4" height="10" rx="1.6" stroke="currentColor" stroke-width="1.2"/><circle cx="5.4" cy="6" r="1.1" stroke="currentColor" stroke-width="1.1"/><path d="M2.4 10.6l3-2.7 2.6 2.3 2.2-1.9 2.4 2.1" stroke="currentColor" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"/></svg>',
    pdf:      '<svg width="15" height="15" viewBox="0 0 15 15" fill="none"><path d="M4 1.5h4L11 4.5v8a.7.7 0 01-.7.7H4a.7.7 0 01-.7-.7v-10a.7.7 0 01.7-.8z" stroke="currentColor" stroke-width="1.2"/><path d="M7.5 1.5V5h3" stroke="currentColor" stroke-width="1.2"/><path d="M5.3 11.2c1.6-.5 2.6-2.2 2.4-3.2-.2-.9-1.1-.7-1.1.3 0 1.4 1.5 2.6 3.1 2.4" stroke="currentColor" stroke-width="1.1" stroke-linecap="round"/></svg>',
    // The generic fallback for any other attachment (.dwg, .docx, .zip). Note this is ICON.doc,
    // not ICON.file — `file` exists only in FIELD_ICON, and reaching for ICON.file interpolates
    // the string "undefined" into the row.
    doc:      '<svg width="15" height="15" viewBox="0 0 15 15" fill="none"><path d="M4 1.5h4L11 4.5v8a.7.7 0 01-.7.7H4a.7.7 0 01-.7-.7v-10a.7.7 0 01.7-.8z" stroke="currentColor" stroke-width="1.2"/><path d="M7.5 1.5V5h3" stroke="currentColor" stroke-width="1.2"/><path d="M5.5 8.5h4M5.5 10.8h2.6" stroke="currentColor" stroke-width="1.1" stroke-linecap="round"/></svg>',
    palette:  '<svg width="18" height="18" viewBox="0 0 18 18" fill="none"><path d="M9 2.4a6.6 6.6 0 000 13.2c.9 0 1.5-.6 1.5-1.4 0-.4-.2-.7-.4-1-.3-.3-.4-.6-.4-.9 0-.8.6-1.4 1.4-1.4h1.3a3.2 3.2 0 003.2-3.2C15.6 4.7 12.7 2.4 9 2.4z" stroke="currentColor" stroke-width="1.3" stroke-linejoin="round"/><circle cx="6" cy="8" r=".95" fill="currentColor"/><circle cx="9" cy="5.9" r=".95" fill="currentColor"/><circle cx="12.1" cy="7.7" r=".95" fill="currentColor"/></svg>',
